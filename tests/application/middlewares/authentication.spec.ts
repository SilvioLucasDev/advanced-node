...
describe('AuthenticationMiddleware', () => {
  ...
  it('should return 403 authorization is empty', async () => {
  ...
  it('should return 403 authorization is null', async () => {
  ...
  it('should return 403 authorization is undefined', async () => {
