...
describe('SavePictureController', () => {
  ...
  it('should return 400 if file MIME type is invalid', async () => {
    const httpResponse = await sut.handle({ file: { buffer, mimeType: 'invalid_mime_type' }, userId })
  ...
  it('should not return 400 if file MIME type is valid', async () => {
